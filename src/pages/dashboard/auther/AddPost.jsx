        ...
        <div>
            ...
            <form onSubmit={handleAddPost} action="" className='w-full  border rounded-2xl  lg:p-6'>
                ...
                <div className="w-full p-3">
                    ...
                    <input type="text" name='tag01' placeholder="tag01" className="mt-1 w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border  rounded-sm transition-all duration-500 " />
